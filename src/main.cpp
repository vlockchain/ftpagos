...
uint256 hashGenesisBlock("0x5821629a2e0ef96cf1ed822745902d05a3eef27e95c2713d5d0b02c8f12809c0");
...
const string strMessageMagic = "FICTECPagos Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // FICTECPagos: 0.35 days
static const int64 nTargetSpacing = 15; // FICTECPagos: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal FICTECPagos miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FICTECPagos", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        assert(block.hashMerkleRoot == uint256("0x4bde903e8fc6ce7090bfbd6468e25e8887d98068f98f4233f408a423f39799ba"));
